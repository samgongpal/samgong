...
<div class="homeBox">
    ...
    <div class="home2">
      ...
      <div onclick="location='boardFaqList.jsp'">자주 묻는 질문</div>
      <div onclick="location='boardNotification.jsp'">공지사항</div>
      <div onclick="location='boardQnaList.jsp'">1:1문의</div>
      <div onclick="location='boardView.jsp?view=a'">이용약관</div>
      <div onclick="location='boardView.jsp?view=b'">위치기반서비스</div>
      <div onclick="location='boardView.jsp?view=c'">개인정보처리방침</div>
      <div onclick="location='boardView.jsp?view=d'">스크린 기준</div>
    </div>
